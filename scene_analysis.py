            ...
            messages=[{
                ...
                "content": [
                    {"type": "text", "text": (
                        ...
                        "stand on its own. Anchor it to something clearly visible in the photo (a door, a "
                        "window, a bench, a wall) and make the DEPTH clear where it matters — how far INTO "
                        "the scene to stand: \"in front of\", \"just in front of\", \"beside\", \"level with\". "
                        "Prefer a spot lit from the front or the side: standing directly in front of a bright "
                        "window or doorway silhouettes them, which is the commonest way these photos fail.\n"
                        "Three rules, each of which matters more than sounding interesting:\n"
                        ...
                        "  (3) Any \"left\" or \"right\" is as seen in this photo, not the subject's own.\n"
                        "Examples: \"Stand next to the drawer\", \"Stand in front of the blue door\", "
                        "\"Stand beside the window\", \"Stand level with the bench\". If nothing distinct is "
                        "visible, keep it simple: \"Stand a little left of centre\". No trailing full stop."
                    )},
